...
这是2kbit的 **C#** 版本，但是使用了更好的办法实现以往的功能，此项目旨在优化 [2kbit-cs](https://github.com/Abjust/2kbit-cs)！

构建该机器人的代码片段前，请务必配置好**Mirai Console Loader**以及**C#环境**！
...
## 注意事项
此项目仅仅是我用来练手的，以便2kbit Code: INTP的开发工作能够顺利展开，因此，此项目将 **不会** 接受任何Issue
## 精品推荐（迫真）
**⚠️小心：有屎山在此处浑水摸鱼⚠️**
- Abjust（本项目作者）
